...
- Generated at: 2026-03-14T12:18:40.326Z
...
- Raw report: [plugin-recall-comparison](~/.openclaw/extensions/memory-mem0/reports/plugin-recall-comparison-2026-03-14T12-17-37-755Z.json)

## Summary

| Metric | memory-mem0 | official mem0 plugin |
|---|---:|---:|
| Recall hits (40 cases) | 25/40 | 18/40 |
| Recall hit rate | 62.5% | 45.0% |
| Avg recall time | 764 ms | 798 ms |
| Avg injected chars | 283 | 176 |

## Difference Breakdown

- Current plugin only hits: 12
- Official plugin only hits: 5
- Both hit: 13
- Both miss: 10
...
- `e2e-10` 用户正在探索哪种移动端开发？ -> expected `iOS开发`
- `e2e-11` 用户正在探索哪种游戏相关方向？ -> expected `游戏开发`
- `e2e-24` turning_zero 对外部行动的默认要求是什么？ -> expected `确认`
- `e2e-31` Gemini embedding-001 的向量维度是多少？ -> expected `3072`
- `e2e-38` 目标记忆架构的第2层是什么？ -> expected `可搜索的长期记忆`
