...
export const TURNING_ZERO_HISTORY_FACTS: TurningZeroHistoryFact[] = [
  ...
  {
    id: "tz-025",
    text: "只有当前 prompt、注入的 memory facts、USER.md、MEMORY.md 与相关 workspace notes 都没有答案时，turning_zero 才需要调用工具检索。",
    memoryKind: "workflow",
    sourceSession: "00000000-0000-0000-0000-000000000001",
    sourceLabel: "SOUL.md",
  },
