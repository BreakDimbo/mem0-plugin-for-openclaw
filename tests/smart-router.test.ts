...
function createMockConfig(tierModels?: Record<string, string>): MemuPluginConfig {
  return {
    ...
    recall: { enabled: false, topK: 5, threshold: 0.5, maxChars: 1500, cacheMaxSize: 100, cacheTtlMs: 60000 },
    capture: { enabled: false, maxItemsPerRun: 3, minChars: 10, maxChars: 500, maxConversationTurns: 4, dedupeThreshold: 0.8, candidateQueue: { enabled: false, intervalMs: 10000, maxBatchSize: 50 } },
